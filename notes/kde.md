...
War to the left, peace to the right, and history on top. There's way too much here to really get into the nitty-gritty, but, in passing - I was struck by the extent to which the war/peace opposition does (and also doesn't) map onto an opposition between men and women. Peace, to the far right, is basically synonymous with women and children - "Natasha," "Sonya," "Marya," "girl," "lady," "daughter," "mother," "mamma." And women appear almost nowhere else in the network. Whereas the men are much more evenly distributed. Pierre shows up near the connection point with the historiography cluster, surrounded bywords of spiritual anxiety and questing - "doubt," "soul," "time," "world," "live." Anatole, meanwhile, is in the furthest reachest of the peace section, right next to "visitors" (he was one) and "daughters" (he eloped with one). Rostov and Andrei (Andrew in the Garnett translation) are at the bottom, in the middle of an interesting bridge that runs from the peace region on the far right, into the world of the aristocratic salon ("Anna," "Pavlovna," "sitting"), and finally across the divide into the war section. This last transition, though, is made by way of a cluster of terms related to the body and physical contact - "lips," "hand," "fingers," "touched," "eyes," "face," "shoulders," "arm." Which, it seems, are used to describe both the physicality of military life and the niceties of Russian high soceity - the embraces, clasps, arms over shoulders, pats on backs, etc. Andrei and Rostov sit right in the middle of this nexus. The men are scattered across the gradient between war and peace, whereas the women essentially _instantiate_ peace, and have very little interaction with history or war. It's almost as much _War and Women_ as _War and Peace_.

Also, look at the huge amount of of space between "Napoleon" and "Bonaparte," which seem like they should hang together pretty closely. "Napoleon" sits far to the left, along the side of the triangle running from "battle" to "history," in the middle of a section related to military strategy and tactics ("military," "plan," "campaign," "men," "group"). Whereas "Bonaparte" is way down at the bottom of the triangle with Andrei and Rostov in the gradient between the military and the salon. The two names enact different roles in the text - Napoleon is the man himself, and Bonaparte is the Russian imagination of the man.
...
In the process of grouping together the words that are the most similar, the layout algorithm also pushes apart the most distant and unconnected parts of the text, which often take the form of oppositions or poles - the conceptual anchors of the text, the organizing dialectics, the highest- or lowest-level primitives that can't be folded together into something more fundamental.
...
1. what's the best way to select the words that get included in the visualizations? it doesn't work well to include _all_ of them, since most words occur really infrequently (one, two, three times), which doesn't provide enough information to reliably place them inside of a

1. when generating the graphs, there are two free parameters - the bandwidth of the kernel density estimates, and the "skim depth," the number of word-pairs that get skimmed off the top of each of the distribution communities and added to the network as edges. in these examples, I just unscientifically fiddled around with these values to get what seemed to be the most interesting layouts. but, I think there might actually be some really interesting reasons for _why_ some values produce more intuitively "correct" visualizations.

1. beyond the visualizations, what kinds of "metrics" can be extracted from the graphs, for lack of a better term? this is where I really need to learn more about network theory. is there a way to quantify the geometric "differentiation" of the network that becomes really visible in the force-directed layouts? some kind of "modularity" score? would it be possible to identify the words that sit at the
